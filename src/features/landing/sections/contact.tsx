      ...
      <div className="flex flex-col justify-center items-center gap-10">
        ...
        <div className="flex flex-row gap-4">
          ...
          <div className="flex flex-col gap-4 w-2/5">
            ...
            <div className="relative flex flex-col gap-6 bg-gradient-to-br from-[#2d1a0b] to-[#1a0d05] rounded-xl p-8 border border-orange-400 text-white shadow-lg overflow-hidden">
              <div className="text-3xl font-extrabold mb-1">Let&apos;s work together</div>
              ...
              <Link
                href="#projects"
                className="mt-2 w-full flex items-center justify-center gap-2 bg-orange-900 hover:bg-orange-800 text-white font-semibold rounded-full py-3 px-6 text-base transition shadow-md"
              >
            ...
            {/* Social networks */}
            <div className="flex flex-col items-center gap-6 bg-gradient-to-br from-[#1e2746] via-[#2e1e46] to-[#1e2746] rounded-xl p-8 shadow-lg border border-white/10">
              <div className="text-3xl md:text-4xl font-extrabold text-white text-center tracking-wide uppercase mb-2">
                SOCIAL NETWORKS
              </div>
              ...
              <a
                href="/cv.pdf"
                download
                className="mt-2 w-full flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-full py-3 px-6 text-base transition shadow-md backdrop-blur-sm"
              >
          ...
          <div className="flex flex-col gap-6 bg-gradient-to-br from-[#232733] to-[#181a20] rounded-xl p-8 w-3/5 border border-white/10 shadow-lg">
            <div className="text-3xl font-extrabold text-white mb-1">Need more information?</div>
